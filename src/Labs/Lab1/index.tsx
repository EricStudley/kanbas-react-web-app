      ...
      <div id="wd-lab1">
        ...
        <div id="wd-lists">
            ...
            <ol id="wd-your-favorite-recipe">
                <li>Add ice to mixer.</li>
                <li>Add vodka to mixer.</li>
                <li>Add sweetened lime juice to mixer.</li>
                <li>Shake mixer.</li>
                <li>Add ice to copper mug.</li>
                <li>Strain mixer into copper mug.</li>
                <li>Add ginger beer copper mug.</li>
                <li>Add a slice of lime to copper mug.</li>
